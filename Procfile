...
lister:         target/start com.heroku.maven.s3pository.S3Lister
...
disable:        target/start com.heroku.maven.s3pository.JavaOff &&  target/start com.heroku.maven.s3pository.ScalaOff && target/start com.heroku.maven.s3pository.PlayOff
enable:         target/start com.heroku.maven.s3pository.JavaOn &&  target/start com.heroku.maven.s3pository.ScalaOn  && target/start com.heroku.maven.s3pository.PlayOn
